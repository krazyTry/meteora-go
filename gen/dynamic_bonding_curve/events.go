...
func ParseAnyEvent(eventData []byte) (any, error) {
	...
	case Event_EvtClaimProtocolFee:
		...
		return value, nil
	case Event_EvtClaimProtocolLiquidityMigrationFee:
		value := new(EvtClaimProtocolLiquidityMigrationFee)
		err := value.UnmarshalWithDecoder(decoder)
		if err != nil {
			return nil, fmt.Errorf("failed to unmarshal event as EvtClaimProtocolLiquidityMigrationFee: %w", err)
		}
		return value, nil
	...
	case Event_EvtInitializePool:
		...
		return value, nil
	case Event_EvtPartnerClaimPoolCreationFee:
		value := new(EvtPartnerClaimPoolCreationFee)
		err := value.UnmarshalWithDecoder(decoder)
		if err != nil {
			return nil, fmt.Errorf("failed to unmarshal event as EvtPartnerClaimPoolCreationFee: %w", err)
		}
		return value, nil
...
func ParseEvent_EvtClaimProtocolLiquidityMigrationFee(eventData []byte) (*EvtClaimProtocolLiquidityMigrationFee, error) {
	decoder := binary.NewBorshDecoder(eventData)
	discriminator, err := decoder.ReadDiscriminator()
	if err != nil {
		return nil, fmt.Errorf("failed to peek discriminator: %w", err)
	}
	if discriminator != Event_EvtClaimProtocolLiquidityMigrationFee {
		return nil, fmt.Errorf("expected discriminator %v, got %s", Event_EvtClaimProtocolLiquidityMigrationFee, binary.FormatDiscriminator(discriminator))
	}
	event := new(EvtClaimProtocolLiquidityMigrationFee)
	err = event.UnmarshalWithDecoder(decoder)
	if err != nil {
		return nil, fmt.Errorf("failed to unmarshal event of type EvtClaimProtocolLiquidityMigrationFee: %w", err)
	}
	return event, nil
}
...
func ParseEvent_EvtPartnerClaimPoolCreationFee(eventData []byte) (*EvtPartnerClaimPoolCreationFee, error) {
	decoder := binary.NewBorshDecoder(eventData)
	discriminator, err := decoder.ReadDiscriminator()
	if err != nil {
		return nil, fmt.Errorf("failed to peek discriminator: %w", err)
	}
	if discriminator != Event_EvtPartnerClaimPoolCreationFee {
		return nil, fmt.Errorf("expected discriminator %v, got %s", Event_EvtPartnerClaimPoolCreationFee, binary.FormatDiscriminator(discriminator))
	}
	event := new(EvtPartnerClaimPoolCreationFee)
	err = event.UnmarshalWithDecoder(decoder)
	if err != nil {
		return nil, fmt.Errorf("failed to unmarshal event of type EvtPartnerClaimPoolCreationFee: %w", err)
	}
	return event, nil
}
